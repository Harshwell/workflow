 ...
 * - 00_Config.gs owns canonical source headers, aliases, sheet names, routing
...
const SUB_FLOW_SPEC = Object.freeze({
  ...
  RAW_HEADERS: Object.freeze({
    ...
    SERVICE_CENTER: 'repairer_location_store_name',
...
const STATUS_TYPE_BY_LAST_STATUS = Object.freeze({
  ...
  'INSURANCE_CLAIM_WAITING_PAID': 'DONE - WAIT INSURANCE',
...
const POSITION_BY_LAST_STATUS = Object.freeze({
  ...
  'CLAIM_EXPIRE': 'Expired Claim',
  'QOALA_CLAIM_REOPEN': 'Front',
  'QOALA_CLAIM_APPROVE_WALKIN': 'Front',
  'CLAIM_EXPIRE_WALKIN': 'Expired Claim',
...
const COLUMN_TYPES = Object.freeze({
  RAW: Object.freeze({
    'policy_start_datetime': 'DATETIME',
    'policy_end_datetime': 'DATETIME',
    'policy_issued_datetime': 'DATETIME',
    'policy_start_date': 'DATE',
    'policy_end_date': 'DATE',
    'claim_submission_date': 'DATE',
    'claim_submitted_datetime': 'DATETIME',
    'claim_submitted_month': 'DATE',
    'last_activity_log_date': 'DATETIME',
    'last_activity_log_name': 'TEXT',
    'last_update': 'DATETIME',
    'last_update_datetime': 'DATETIME',
    'claim_last_updated_datetime': 'DATETIME',
    'activity_log_datetime': 'DATETIME',
    'last_activity_log_datetime': 'DATETIME',
    'device_checkout_datetime': 'DATETIME',
    'repair_done_datetime': 'DATETIME',
    'replace_done_datetime': 'DATETIME',

    'days_to_end_policies': 'INT',
    'days_aging_from_submission': 'INT',
    'days_aging_from_last_activity': 'INT',
...
const CONFIG = Object.freeze({
  ...
  headers: {
    ...
    policyStartDate: 'policy_start_datetime',
    policyStartDatetime: 'policy_start_datetime',
    policyEndDate: 'policy_end_datetime',
    policyEndDatetime: 'policy_end_datetime',
    activationDatetime: 'policy_issued_datetime',
    policyIssuedDatetime: 'policy_issued_datetime',
    claimSubmissionDate: 'claim_submitted_datetime',
    claimSubmittedDatetime: 'claim_submitted_datetime',
    claimSubmissionMonths: 'claim_submitted_month',
    claimSubmittedMonth: 'claim_submitted_month',
    lastActivityLogDate: 'last_activity_log_datetime',
    ...
    lastActivityLog: 'last_activity_log_name',
    ...
    daysAgingFromLastActivity: 'days_aging_from_last_activity',
    insuranceCode: 'insurance_code',
    lastStatus: 'claim_last_status_name',
    lastStatusAging: 'days_aging_from_last_activity',
    ...
    serviceCenter: 'repairer_location_store_name',
...
partnerCodeAging: 'insurance_partner_code',
    ...
    scName: 'repairer_location_store_name',
    scCity: 'repairer_location_city_name',
    repairerLocationStoreName: 'repairer_location_store_name',
    repairerLocationCityName: 'repairer_location_city_name',
    ...
    businessPartnerCategoryName: 'id_business_partner_category_name',
    pmName: 'pm_name',
    apmName: 'apm_name',
    repairDoneDatetime: 'repair_done_datetime',
    replaceDoneDatetime: 'replace_done_datetime',
    deviceCheckoutDatetime: 'device_checkout_datetime',
    deviceCheckinOptionName: 'device_checkin_option_name',
    deviceCheckoutOptionName: 'device_checkout_option_name',
    picName: 'pic_name',
    // Classify OLD/NEW
    db: 'DB',
    dbClass: 'DB',
    ...
    ALA: 'activity_log_aging',
    TAT: 'days_aging_from_submission',
    LSA: 'days_aging_from_last_activity',

...
/** VERSION */
const APP_VERSION = '2026.02.10-enterprise-refactor-r1';
 ...
 * - ADMIN: core sheets only (NO B2B/Special Case/EV-Bike)
 */
...
const CONFIG = Object.freeze({
  ...
  // New: primary routing config (preferred by new modules)
